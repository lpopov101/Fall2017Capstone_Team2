...
public class CheckpointManagerShell3 : CheckpointManager {
	...
	protected override void LoadSceneFirstTime() {
		...
		PlayerPrefs.SetInt("Shell3_Mem1", 0);
		PlayerPrefs.SetInt("Shell3_Mem2", 0);
		PlayerPrefs.SetInt("Shell3_Mem3", 0);
